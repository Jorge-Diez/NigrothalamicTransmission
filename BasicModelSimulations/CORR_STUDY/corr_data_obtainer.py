...
def neural_data_obtainer(trial_data):
    ...
    for i in range(all_spiketrains.size):
        ...
        if (data.size != 0): # done to avoid second group of empty spikes for specifyneurons
...
root_folder = input("please enter full directory path of the root folder: ")
...
nr_neurons_folder = int(input("please enter total number of neuron experiments per freq folder: "))
...
exp_name = input("please enter directory of the folder for file savings: ")

f = open("corr_results_" + exp_name +".txt", "w+")
f_corr = open("all_trials_corr_results_" + exp_name +".txt", "w+")    
f_trialsTQ = open("all_trials_TQ_results_" + exp_name +".txt", "w+")  




ALL_CORR_values_30 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_40 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_50 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_60 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_70 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_80 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_90 = np.zeros((nr_neurons_folder,40))
ALL_CORR_values_100 = np.zeros((nr_neurons_folder,40))



ALL_CORR_differences_30 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_40 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_50 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_60 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_70 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_80 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_90 = np.zeros((nr_neurons_folder,40))
ALL_CORR_differences_100 = np.zeros((nr_neurons_folder,40))



ALL_CORR_percentages_30 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_40 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_50 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_60 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_70 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_80 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_90 = np.zeros((nr_neurons_folder,40))
ALL_CORR_percentages_100 = np.zeros((nr_neurons_folder,40))
...
with open('corrmatrixes' +  exp_name + '.pickle', 'wb') as handle:
        pickle.dump(ALL_CORR_MAT_LIST, handle, protocol=pickle.HIGHEST_PROTOCOL)
        
with open('corrdiffmatrixes' +  exp_name + '.pickle', 'wb') as handle:
        pickle.dump(ALL_CORRDIFF_MAT_LIST, handle, protocol=pickle.HIGHEST_PROTOCOL)
        
        
with open('corrpercmatrixes' +  exp_name + '.pickle', 'wb') as handle:
